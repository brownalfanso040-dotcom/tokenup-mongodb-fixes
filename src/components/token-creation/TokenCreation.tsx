                  ...
                  <div className='space-y-4 pl-6 border-l-2 border-cyan-500/30'>
                    ...
                    <div className='bg-cyan-500/10 border border-cyan-500/30 rounded-lg p-3'>
                      <p className='text-sm text-cyan-400'>
                        <strong>PumpFun Mode:</strong> Creates tokens using PumpFun program addresses with enhanced features like bonding curves and automatic liquidity.
                        {tokenMetaData.useJitoBundling && (
                          <span className='block mt-1'>
                            <strong>Jito Bundling:</strong> Provides MEV protection by bundling transactions together.
                          </span>
                        )}
                      </p>
                    </div>
                ...
                {!tokenMetaData.usePumpFun && (
                  <div className='bg-blue-500/10 border border-blue-500/30 rounded-lg p-3'>
                    <p className='text-sm text-blue-400'>
                      <strong>SPL Token 2022 Mode:</strong> Creates standard Solana tokens with metadata extensions and authority controls.
                    </p>
                  </div>
                )}
              </div>
